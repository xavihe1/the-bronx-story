...
sprites.onOverlap(SpriteKind.Player, SpriteKind.story_button, function (sprite, otherSprite) {
...
miniMapa = sprites.create(img`
    ...
    `, SpriteKind.Player)
is_on_map_level = false
music.play(music.createSong(hex``), music.PlaybackMode.LoopingInBackground)
...
game.onUpdateInterval(100, function () {
    if (npc_can_shoot) {
        timer.after(randint(350, 560), function () {
            npc_can_shoot = false
