...
sprites.onOverlap(SpriteKind.npc_duel, SpriteKind.Projectile, function on_on_overlap(sprite22: Sprite, otherSprite22: Sprite) {
    ...
    if (otherSprite22 == main_character_bullet && npc_football == sprite22 && !is_shoot_done) {
    ...
    } else if (otherSprite22 == main_character_bullet && final_mom_sprite == sprite22 && !is_shoot_done) {
        is_shoot_done = true
        sprites.destroy(otherSprite22, effects.fire, 500)
        game.splash("You win, pero a que coste?")
        final_mom_sprite.setImage(img`
            . . . . . 2 f f 2 2 2 2 2 . . . 
        ...
        `)
        is_player_talking = false
        story.spriteSayText(final_mom_sprite, "X.X")
        pause(1000)
        story.spriteSayText(npc_building, "Te quiero hijo")
        final_mom_sprite.setKind(SpriteKind.Complete)
        destroy_1v1()
        mom_death_ending()
    }
...
function mom_death_ending() {
    ...
    sprites.destroyAllSpritesOfKind(SpriteKind.Complete)
    mom_at_bed_sprite = sprites.create(img`
            . . . . . . . . f f . . . . . . 
                    ...
                    . . . . . . . . f f . . . . . .
        `, SpriteKind.Npc)
    mom_at_bed_sprite.setPosition(52, 65)
}
...
function start_npc_duel(npc: Sprite) {
    ...
    if (npc == npc_football) {
        ...
        `)
        npc.setPosition(111, 58)
        main_character.setPosition(12, 58)
        ...
        scene.setBackgroundImage(img`
            999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
                        ...
                        444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444
        `)
        npc.setPosition(107, 64)
        main_character.setPosition(56, 64)
    } else if (npc == final_mom_sprite) {
        scene.setBackgroundImage(img`
            
                        ...
                        ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        `)
        npc.setPosition(132, 102)
        main_character.setPosition(25, 102)
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.mom, function on_on_overlap2(sprite222: Sprite, otherSprite222: Sprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Npc, function on_on_overlap3(sprite2: Sprite, otherSprite2: Sprite) {
    ...
    if (!showMinimap && is_on_map_level) {
        ...
        if (!showMinimap && controller.A.isPressed()) {
            ...
            if (otherSprite2 == npc_start && !showMinimap) {
                ...
                story.showPlayerChoices("No puede ser, tienes que pagar por esto!!", "Lo hablamos en casa tranquilos")
                if (story.checkLastAnswer("Lo hablamos en casa tranquilos")) {
    ...
    if (otherSprite2 == mom_at_bed_sprite && !showMinimap) {
        is_player_talking = true
        main_character.z = 0
        story.printCharacterText("Mamá, me da mucha pena verte así", main_character_name)
        story.printCharacterText("Me lo he buscado hijo, estaba cegada por el dinero, perdoname", "Mamá")
        story.printCharacterText("Te quiero mucho, en nada te darán el alta", main_character_name)
        carnival.customGameOverExpanded("Terminaste el juego!", effects.confetti, music.bigCrash, carnival.ScoreTypes.None)
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile, function on_on_overlap4(sprite223: Sprite, otherSprite223: Sprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.story_button, function on_on_overlap5(sprite: Sprite, otherSprite: Sprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.twoPlayersButton, function on_on_overlap6(sprite3: Sprite, otherSprite3: Sprite) {
    cursor.sayText("A para jugar")
    if (controller.A.isPressed()) {
        two_players_screen()
    }
...
let mom_at_bed_sprite : Sprite = null
