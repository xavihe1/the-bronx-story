...
controller.up.onEvent(ControllerButtonEvent.Pressed, function on_up_pressed() {
    if (isPlayerLive) {
        animation.runImageAnimation(player_1, [img`
                    . . . . f f f f . . . . . 
                                . . f f c c c c f f . . . 
                                . f f c c c c c c f f . . 
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.storyButton, function on_on_overlap(sprite: Sprite, otherSprite: Sprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.twoPlayersButton, function on_on_overlap2(sprite3: Sprite, otherSprite3: Sprite) {
    cursor.sayText("Press A to play")
    if (controller.A.isPressed()) {
        TwoPlayersScreen()
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.mom, function on_on_overlap3(sprite2: Sprite, otherSprite2: Sprite) {
...
doMenu()
isPlayerLive = false
let miniMapa = sprites.create(img`
        . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
...
game.onUpdateInterval(100, function on_update_interval() {
    ...
    if (showMinimap) {
        ...
        minimap.includeSprite(myMinimap, player_1, MinimapSpriteScale.Octuple)
        miniMapa.setImage(minimap.getImage(myMinimap))
        miniMapa.setPosition(scene.cameraProperty(CameraProperty.Right) - 33, scene.cameraProperty(CameraProperty.Top) + 35)
    }
