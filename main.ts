...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile, function on_on_overlap2(sprite2: Sprite, otherSprite2: Sprite) {
    ...
    if (otherSprite2 == player_2_bullet && mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)) == sprite2 && !is_shoot_done) {
        is_shoot_done = true
    ...
    } else if (otherSprite2 == player_1_bullet && mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)) == sprite2 && !is_shoot_done) {
        is_shoot_done = true
        sprites.destroy(otherSprite2, effects.fire, 500)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.twoPlayersButton, function on_on_overlap3(sprite3: Sprite, otherSprite3: Sprite) {
    cursor.sayText("Press A to play")
    if (controller.A.isPressed()) {
        TwoPlayersScreen()
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.mom, function on_on_overlap4(sprite22: Sprite, otherSprite22: Sprite) {
